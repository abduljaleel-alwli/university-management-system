<div class="px-6 ">
    <div class="my-6 mx-auto bg-white shadow-soft-xl rounded-2xl p-6">
        ...
        <div>
            <label for="title_ar" class="block text-gray-700 font-medium mt-4 mb-2">{{ __('Research Title (Arabic)') }}</label>
        ...
        <div>
            <label for="title_en"
                class="block text-gray-700 font-medium mb-2">{{ __('Research Title (English)') }}</label>
        ...
        <div>
            <label for="journal_name" class="block text-gray-700 font-medium mt-4 mb-2">{{ __('Journal Name') }}</label>
        ...
        <div>
            <label for="journal_url" class="block text-gray-700 font-medium mt-4 mb-2">{{ __('Journal Link') }}</label>
        ...
        <div>
            <label for="publication_date"
                class="block text-gray-700 font-medium mb-2">{{ __('Publication Date') }}</label>
        ...
        <div>
            <label for="research_url"
                class="block text-gray-700 font-medium mb-2">{{ __('Research Link') }}</label>
        ...
        <div>
            <label for="notes"
                class="block text-gray-700 font-medium mb-2">{{ __('Note') }}</label>
            <textarea wire:model="notes" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" rows="4">{{ old('notes') }}</textarea>
            @error('notes')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            <label for="status" class="block text-gray-700 font-medium mt-4 mb-2">{{ __('Status') }}</label>
    ...
    <!-- نموذج البحث -->
    <div class="bg-white shadow-soft-xl rounded-2xl p-6 my-12">
        <div class="pb-4"
