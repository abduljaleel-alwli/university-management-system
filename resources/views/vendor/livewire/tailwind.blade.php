                        ...
                        <span>
                            ...
                            @if ($paginator->onFirstPage())
                                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}"
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-400 bg-gray-200 border border-gray-300 rounded-l-md cursor-not-allowed dark:bg-gray-700 dark:border-gray-600">
                            ...
                            @else
                                <button type="button" wire:click="previousPage('{{ $paginator->getPageName() }}')"
                                    ...
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-l-md hover:text-gray-800 hover:bg-gray-100 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                </button>
