<!-- Modal -->
<div id="specializationModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-md relative z-50">
            <div class="flex justify-between items-center p-4 border-b">
                <h3 class="text-lg font-semibold" id="modal-title">{{ __('Add Specialization') }}</h3>
            ...
            <div class="p-4">
                <form id="specializationForm" onsubmit="submitForm(event)">
                    <div class="mb-4">
