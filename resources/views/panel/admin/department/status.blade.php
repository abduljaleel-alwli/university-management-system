            ...
            <form id="paymentForm">
                ...
                <div class="mb-4 flex gap-4 items-center">
                    <div class="w-1/2">
                        ...
                        <select id="currency" name="currency" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <div class="w-1/2">
                        ...
                        <input type="date" id="payment_date" name="payment_date" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                    </div>
                </div>
